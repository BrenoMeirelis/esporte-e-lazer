...
@section('content')
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('users.create') }}" class="btn text-white rounded-pill px-4 shadow-sm"
        ...
        <div class="card border-0 shadow-lg rounded-4">
            ...
            <div class="card-header text-white rounded-top-4" style="background: linear-gradient(135deg, #4f46e5, #9333ea);">
