...
<style>
    ...
    .page-hero p { color: #8080b0; font-size: 15px; margin: 0; }
    ...
    .stat-pill strong { font-weight: 600; color: #1a1a2e; }
    ...
    .filter-btn.active { border-color: #4a4aff; color: #4a4aff; background: #f0f0ff; }
    .filter-btn[data-status="pendente"].active { border-color: #d97706; color: #d97706; background: #fef3c7; }
    .filter-btn[data-status="aprovada"].active { border-color: #16a34a; color: #16a34a; background: #dcfce7; }
    .filter-btn[data-status="recusada"].active { border-color: #dc2626; color: #dc2626; background: #fee2e2; }
    ...
    .status-pendente .reserva-status-bar  { background: #f59e0b; }
    .status-aprovada .reserva-status-bar  { background: #22c55e; }
    .status-recusada .reserva-status-bar  { background: #ef4444; }
    ...
    .reserva-meta span { display: flex; align-items: center; gap: 4px; }
    ...
    .badge-aprovada  { background: #dcfce7; color: #14532d; }
    .badge-recusada  { background: #fee2e2; color: #7f1d1d; }
    ...
    .reserva-card:hover .reserva-action { color: #4a4aff; }
    ...
    .btn-nova-reserva:hover { background: #4a4aff; color: #fff; }

    @media(max-width: 640px) {
        .reserva-content { flex-wrap: wrap; gap: 12px; }
        .reserva-data-box { display: none; }
...
<div class="container" style="padding-top: 28px;">
    ...
    @if(session('success'))
    <div style="background:#e8f8f0;border:1px solid #b5e8d0;color:#1a7a50;border-radius:10px;padding:12px 18px;margin-bottom:20px;font-size:14px;display:flex;align-items:center;gap:8px;">
    ...
    <div class="reservas-list" id="reservas-list">
        ...
        <a href="{{ route('reservas.show', $reserva->id) }}"
           class="reserva-card status-{{ $status }}"
           data-status="{{ $status }}">
            ...
            <div class="reserva-content">
                ...
                <div class="reserva-info">
                    ...
                    <div class="reserva-meta">
                        ...
                        <span><i class="bi bi-clock"></i> {{ \Carbon\Carbon::parse($reserva->hora_inicio)->format('H:i') }} — {{ \Carbon\Carbon::parse($reserva->hora_fim)->format('H:i') }}</span>
        ...
        btn.addEventListener('click', function () {
            ...
            if (count === 0 && cards.length > 0) {
                if (!emptyEl) {
                    ...
                    emptyEl.innerHTML = '<div class="icon">🔍</div><h3>Nenhuma reserva neste filtro</h3>';
